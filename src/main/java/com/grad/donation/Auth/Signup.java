package com.grad.donation.Auth;
...
import com.grad.donation.Utils.AESCrypt;
...
public class Signup extends AppCompatActivity {
    ...
    private boolean validate() {
        if (mName.getText().toString().isEmpty()) {
            ...
            Toast.makeText(this, "Enter valid phone number (10 digits) or more", Toast.LENGTH_LONG).show();
            return false;
